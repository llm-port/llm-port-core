...
class Settings(BaseSettings):
    """Application settings for the Skills Registry service."""
    ...
    # ── Skills defaults ──
    max_published_skills_per_tenant: int = 25
    max_versions_per_skill: int = 5
    max_assignments_per_tenant: int = 10

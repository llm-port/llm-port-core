...
_ADMIN_ALLOW: dict[tuple[ContainerClass, Action], bool] = {
    ...
    # MCP — MCP servers; similar to SYSTEM_AUX, lifecycle allowed
    (ContainerClass.MCP, Action.VIEW): True,
    (ContainerClass.MCP, Action.LOGS_VIEW): True,
    (ContainerClass.MCP, Action.START): True,
    (ContainerClass.MCP, Action.STOP): True,
    (ContainerClass.MCP, Action.RESTART): True,
    (ContainerClass.MCP, Action.PAUSE): False,
    (ContainerClass.MCP, Action.UNPAUSE): False,
    (ContainerClass.MCP, Action.EXEC): False,
    (ContainerClass.MCP, Action.UPDATE_CONFIG): False,
    (ContainerClass.MCP, Action.DELETE): False,
    (ContainerClass.MCP, Action.IMAGE_PULL): True,
    (ContainerClass.MCP, Action.IMAGE_PRUNE): False,
    (ContainerClass.MCP, Action.STACK_DEPLOY): False,
    (ContainerClass.MCP, Action.STACK_UPDATE): False,
    (ContainerClass.MCP, Action.STACK_ROLLBACK): False,

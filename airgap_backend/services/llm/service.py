...
from airgap_backend.db.dao.llm_dao import (
    ArtifactDAO,
    DownloadJobDAO,
    ModelDAO,
    ProviderDAO,
...
from airgap_backend.services.llm.base import ContainerSpec
from airgap_backend.services.llm.registry import get_adapter
from airgap_backend.services.llm.scanner import scan_model_directory
...
class LLMService:
    ...
    async def start_download(
        ...
        *,
        ...
        from airgap_backend.services.llm.tasks import download_model_task  # noqa: PLC0415

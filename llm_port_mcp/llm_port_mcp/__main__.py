...
def set_multiproc_dir() -> None:
    ...
    Cleans up and recreates the multiprocess directory required
    by prometheus-client for sharing metrics between workers.
    """
...
def main() -> None:
    ...
    set_multiproc_dir()
    uvicorn.run(
        "llm_port_mcp.web.application:get_app",
